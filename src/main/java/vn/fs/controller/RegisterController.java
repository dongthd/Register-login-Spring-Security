...
import vn.fs.entity.Role;
import vn.fs.entity.User;
import vn.fs.repo.UserRepository;
...
public class RegisterController {
	...
	public ModelAndView confirmRegister(ModelMap model, @ModelAttribute("user") User dto, @RequestParam("password") String password,
